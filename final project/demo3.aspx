<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="demo3.aspx.cs" Inherits="final_project.demo3" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <asp:Image ID="Image2" runat="server" Height="250px" Width="499px" />
   ...
   <asp:ImageButton ID="ImageButton2" runat="server" Height="237px" 
        ...
        BorderWidth="10px" 
                onclientclick="alert('sorry ! you are not a candidate    ,can not see this')" />
