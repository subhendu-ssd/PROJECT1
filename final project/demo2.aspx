<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="demo2.aspx.cs" Inherits="final_project.demo2" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Timer ID="Timer1" runat="server" Interval="1000" ontick="Timer1_Tick1">
            ...
            BorderWidth="10px" 
                onclientclick="alert('sorry ! you are not a conpamy    ,can not see this')" />
